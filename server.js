...
* **★★★ 絵文字の利用ルール ★★★:**
    ...
    * **Instagramフィード, Facebook, LinkedIn, Threads, Spotify:** 投稿内容の魅力を高めるため、文脈に合わせて3〜5個の絵文字を積極的に使用してください。特に、箇条書きや重要なポイントで活用すると効果的です。
    * **リール動画のセリフ構成:** タイトルや各セリフに絵文字は不要です。
...
* **各SNSの詳細ルール:**
    ...
    2.  **Instagramストーリーズ:**
        ...
        * **構成案（字幕＋CTA）:** ハッシュタグ不要
    3.  **Instagramフィード:**
        * **キャプション短文:** 文字数: 125〜150文字, ハッシュタグ: 5個
        * **構成案（カルーセル形式）:** 5〜6枚構成
    4.  **Facebook:** キャプション本文: 150〜200文字, ハッシュタグ: 5個
    5.  **LinkedIn:** キャプション本文: 200〜300文字, ハッシュタグ: 5個
